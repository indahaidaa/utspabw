...
<head>
    ...
    <title>INDAH AIDA SAPITRI</title>
    <link rel="stylesheet" href="<?php echo url_dasar()?>/css/style.css">
</head>
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href='<?php echo url_dasar()?>'> Welcome</a></div>
            <div class="menu">
                <ul>
                    <li><a href="<?php echo url_dasar()?>#home">Home</a></li>
                    <li><a href="<?php echo url_dasar()?>#courses">Profile</a></li>
                    <li><a href="<?php echo url_dasar()?>#tutors">News</a></li>
                    <li><a href="<?php echo url_dasar()?>#partners">Gallery</a></li>
